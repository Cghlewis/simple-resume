...
\begin {center}
I am an education researcher with over ten years of experience in project coordination and supervision, as well as data management, analysis, and reporting. I am happiest working at the intersection of K-12 education research and data management planning, helping researchers and practitioners strategize and implement reproducible workflows and organization-wide data management practices that lead to more secure, reliable, and reproducible data. Ultimately, my goal is to allow researchers to spend more time using data to make positive changes in the field, and less time wrangling their data into a usable and shareable format.
\end{center}

# Technical Skills

R, Qualtrics, Git and GitHub, SPSS, Microsoft Access, Stata, Quick Base, SQL, SharePoint, Tableau
...
tribble(
  ...
  "Data Management Consultant", "Freelance", "Remote", "Mar 2022 - Present", "Composing a draft of the book 'Data Management in Large-Scale Education Research' at https://datamgmtinedresearch.com",
  "Data Scientist", "Streamline Data Science", "Remote", "Nov 2021 - Mar 2022", "Created example client facing crm dashboard in R flexdashboard to demonstrate services.",
  ...
  "Director of Data Strategy", "Missouri Prevention Science Institute", "University of Missouri", "May 2019 - Nov 2021", "Strategized data management plans for over ten actively funded projects and oversaw their implementation.",
    "Director of Data Strategy", "Missouri Prevention Science Institute", "University of Missouri", "May 2019 - Nov 2021","Created standard operating procedures for all data management systems and provided annual staff training on systems.",
  "Director of Data Strategy", "Missouri Prevention Science Institute", "University of Missouri", "May 2019 - Nov 2021", "Built a team SharePoint site and oversaw migration of all files from our former system to the new site.",
  ...
  "Director of Research Implementation","", "", "Jul 2016-May 2019",
  "Delivered quarterly trainings to staff on data collection methods.", 
  ...
  "Director of Research Implementation", "", "", "Jul 2016-May 2019", "Build reports, dashboards, and visualizations for the dissemination of data.",
...
tribble(
  ...
  "Advisory Committee Member", "Center for Open Science Unconference on Open Scholarship Practices in Education", "Remote", "Oct 2022 - Mar 2023", "Assist in planning the 2023 event",
...
# Oversaw Data Management for the Following Grants
...
Lewis, C. (2023). Cleaning Medical Data in R. A forthcoming workshop for the R in Medicine conference June 5-9, 2023, Online.

Lewis, C. (2022). Data Management Workflow for Education Research Studies. Guest lecture given to a graduate research methods class at the University of Houston-Clear Lake, Online.
