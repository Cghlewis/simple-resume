...
tribble(
  ...
  "Data Scientist", "Streamline Data Science", "Remote", "Nov 2021 - Mar 2022", "Built example client facing crm dashboard in R flexdashboard to be used to publicize services. Currently featured on Streamline’s website.",
...
flexdashboard that is automated through Google Cloud Platform to update daily. The dashboard is used regularly by the sales team.",
