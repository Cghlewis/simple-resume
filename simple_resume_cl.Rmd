...
tribble(
  ...
  "Director of Data Strategy", "Missouri Prevention Science Institute", "University of Missouri", "May 2019 - Nov 2021", "Built a secure and user-friendly team SharePoint site and oversaw migration of all files from our former system to the new site.",
  "Director of Data Strategy", "Missouri Prevention Science Institute", "University of Missouri", "May 2019 - Nov 2021", "Designed a streamlined internal data request system in Qualtrics, removing the burden of back and forth email exchanges.",
    "Director of Data Strategy", "Missouri Prevention Science Institute", "University of Missouri", "May 2019 - Nov 2021", "Merged, cleaned, transformed, queried, and documented data collected from school districts, state education agencies, surveys, assessments, and observations using R.",
  ...
  "Director of Research Implementation", "", "", "Jul 2016-May 2019", "Built reports, dashboards, and visualizations for the dissemination of data.",
...
tribble(
   ~ role, ~ company, ~ loc, ~ dates, ~ details,
   "Organizer", "POWER Issues in Data Management in Education Research Hub", "Remote", "Jan 2022 - Present", "Organize and host monthly meetups and presentations on data management topics for a group of researchers and data managers in the field of education.",
